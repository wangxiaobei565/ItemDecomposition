...
mkdir -p output/kr/agents/slate/itemA2C_W/
    ...
    do
        ...
        do
            ...
            do
                ...
                do
                    mkdir -p ${output_path}agents/slate/itemA2C_W/Item_A2CW_kr_slate_${SLATE}_seed${SEED}/
                    ...
                    python train_ac.py\
                        ...
                        --save_path ${output_path}agents/slate/itemA2C_W/Item_A2CW_kr_slate_${SLATE}_seed${SEED}/model\
                        ...
                        --check_episode 10\
                        --topk_rate ${TOPK}\
                        > ${output_path}agents/slate/itemA2C_W/Item_A2CW_kr_slate_${SLATE}_seed${SEED}/log
                done
            done
        done
    done
