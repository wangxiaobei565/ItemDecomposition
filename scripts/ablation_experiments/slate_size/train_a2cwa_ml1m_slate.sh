...
mkdir -p output/ml1m/agents/slate/weight_wa/
    ...
    do
        ...
        do
            ...
            do
                ...
                do
                    mkdir -p ${output_path}agents/slate/weight_wa/Item_A2CWA_ml1m_slate_${SLATE}_seed${SEED}/
                    ...
                    python train_ac.py\
                        ...
                        --save_path ${output_path}agents/slate/weight_wa/Item_A2CWA_ml1m_slate_${SLATE}_seed${SEED}/model\
                        ...
                        --check_episode 10\
                        --topk_rate ${TOPK}\
                        > ${output_path}agents/slate/weight_wa/Item_A2CWA_ml1m_slate_${SLATE}_seed${SEED}/log
                done
            done
        done
    done
