...
mkdir -p output/kr/agents/slate/itemA2C_weight/
    ...
    do
        ...
        do
            ...
            do
                ...
                do
                    mkdir -p ${output_path}agents/slate/itemA2C_weight/Item_A2CW_kr_slate_${SLATE}_seed${SEED}/
                    ...
                    python train_ac_weight.py\
                        ...
                        --save_path ${output_path}agents/slate/itemA2C_weight/Item_A2CW_kr_slate_${SLATE}_seed${SEED}/model\
                        ...
                        --check_episode 10\
                        --topk_rate ${TOPK}\
                        > ${output_path}agents/slate/itemA2C_weight/Item_A2CW_kr_slate_${SLATE}_seed${SEED}/log
                done
            done
        done
    done
