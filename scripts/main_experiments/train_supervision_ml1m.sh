...
mkdir -p output/ml1m/agents/reqsuper/
...
for MAX_STEP in 20 
do
#     for BEHAVIOR_LR in 0.01 0.001 0.0001 0.00001 0.000001 0.0000001
    for BEHAVIOR_LR in 0.0001
    do
        ...
        do
            ...
            do
                ...
                do
                    mkdir -p ${output_path}agents/reqsuper/Super_${SCORER}_behavior${BEHAVIOR_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/
                    ...
                    python train_ac.py\
                        ...
                        --save_path ${output_path}agents/reqsuper/Super_${SCORER}_behavior${BEHAVIOR_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/model\
                        ...
                        --check_episode 10\
                        --topk_rate ${TOPK}\
                        > ${output_path}agents/reqsuper/Super_${SCORER}_behavior${BEHAVIOR_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/log
                done
            done
        done
    done
