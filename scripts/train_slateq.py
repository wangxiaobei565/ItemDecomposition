...
if __name__ == '__main__':
    ...
    init_parser.add_argument('--critic_class', type=str, default='SlateQCritic', help='Critic class')
    init_parser.add_argument('--agent_class', type=str, default='SlateQ', help='Learning agent class')
...
#     print(policy)
    ...
    print("Setup critic:")
    critic = criticClass(args, env)
    critic.to(device)
    print(critic)
    print("Setup agent with data-specific facade")
    facade = facadeClass(args, env, critic)
