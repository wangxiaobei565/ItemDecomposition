...
from model.agents.SlateQ import SlateQ
    
class BehaviorSlateQ(SlateQ):
    '''
    ...
    def parse_model_args(parser):
        ...
        - from SlateQ:
            ...
            - args from BaseRLAgent:
                ...
                - save_path
        '''
        parser = SlateQ.parse_model_args(parser)
...
#                             help='behaviorvise loss coefficient')
    ...
    def __init__(self, args, facade):
        ...
        self.behavior_lr
        self.behavior_decay
        self.critic_behavior_optimizer
        from DDPG:
        ...
        self.critic_behavior_optimizer = torch.optim.Adam(self.critic.parameters(), lr=args.behavior_lr, 
...
#         observation, exposure, feedback = self.facade.sample_supervise_data(self.batch_size)
        ...
        policy_output = self.facade.apply_policy(observation, self.critic)
...
#         behavior_loss = self.facade.get_policy_gradient_loss(observation, policy_output, next_observation, self.actor)
        ...
        if do_update and self.behavior_lr > 0:
            self.critic_behavior_optimizer.zero_grad()
            behavior_loss.backward()
            self.critic_behavior_optimizer.step()
        return behavior_loss
